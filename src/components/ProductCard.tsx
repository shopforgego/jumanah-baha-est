...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="group bg-white border border-rose-100 hover:border-rose-400 shadow-sm hover:shadow-xl rounded-2xl overflow-hidden transition-all duration-300 flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          <span className="text-[11px] text-rose-600 font-bold mb-1 block">{product.category}</span>
          <h3
        ...
        <div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white font-bold shadow-lg shadow-rose-600/20 py-2.5 px-3 rounded-xl transition text-xs font-bold"
          >
