...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className="bg-gradient-to-b from-[#fff1f5] via-[#ffe4ee] to-[#fffafb] text-slate-900 border-b border-current/10 pt-8 pb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 text-right">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/20 border border-current/10 text-xs font-bold mb-4">
              ...
              <span>✨ كولكشن العبايات الملكية 2026</span>
            </div>

            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-black leading-tight mb-4 tracking-tight">
              أناقة شرقية تفيض بالأنوثة والوقار
            </h1>

            <p className="text-sm sm:text-base opacity-90 mb-6 leading-relaxed max-w-2xl font-normal">
              أرقى تصاميم العبايات والفساتين والأزياء النسائية المحتشمة بأقمشة كورية ويابانية فاخرة - مرحباً بكم في <strong className="underline decoration-current/30">{storeConfig.companyNameAr}</strong>.
            </p>

            <div className="flex flex-wrap items-center gap-4">
              <a
                href="#products-grid"
                className="bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white font-bold shadow-lg shadow-rose-600/20 inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm transition transform active:scale-95"
              >
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-rose-400/40 group">
              <img
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all ${
                selectedCategory === 'all'
                  ? ' bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white font-bold shadow-lg shadow-rose-600/20 '
