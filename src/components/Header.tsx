...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 text-slate-900 border-b border-rose-100 backdrop-blur-md shadow-lg">
      <div className="bg-gradient-to-r from-rose-700 via-rose-600 to-rose-700 text-white font-bold text-xs py-1.5 px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={onOpenCart}
              className="relative flex items-center gap-2 bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white font-bold shadow-lg shadow-rose-600/20 px-4 py-2.5 rounded-xl transition transform active:scale-95"
            >
