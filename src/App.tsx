...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fffafb] text-slate-900 flex flex-col font-sans">
      <Header
        ...
        {filteredProducts.length === 0 ? (
          <div className="bg-black/5 border border-current/10 rounded-3xl p-12 text-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white font-bold shadow-lg shadow-rose-600/20 text-xs px-4 py-2 rounded-xl"
            >
              إعادة تعيين البحث
            </button>
          </div>
